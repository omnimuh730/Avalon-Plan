import type { JsonSchemaDefinition } from './chat-types.js';
      ...
      fields: {
        ...
        items: {
          ...
          properties: {
            id: {
              type: 'string',
              description: 'Field id from input (groupIndex:childIndex)',
            },
            action: {
              type: 'string',
            ...
            value: {
              type: 'string',
              description: 'Text to type, exact option label, or N/A for Click / skip',
            },
            notes: {
              type: 'string',
