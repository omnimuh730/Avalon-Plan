    ...
    <header className="h-14 flex items-center px-6 border-b border-border bg-background/95 backdrop-blur-xl sticky top-0 z-20 flex-shrink-0">
      ...
      <div className="flex items-center gap-2">
        <div className="flex items-center gap-2 bg-secondary border border-border rounded-xl px-4 py-2 w-56 hover:border-primary/30 transition-colors cursor-text min-h-10">
          ...
          <kbd
            className="text-xs text-muted-foreground/60 bg-card px-2 py-0.5 rounded border border-border"
            style={mono}
          >
            ⌘K
          </kbd>
        </div>
        <button className="flex items-center gap-2 bg-primary/10 hover:bg-primary/15 border border-primary/20 text-primary px-4 py-2 rounded-xl text-sm font-bold transition-colors min-h-10">
          <Sparkles className="w-4 h-4" />
          AI
        </button>
        <button className="relative icon-btn text-muted-foreground hover:text-foreground hover:bg-secondary">
          <Bell className="w-5 h-5" />
          <span className="absolute top-2 right-2 w-2 h-2 rounded-full bg-primary" />
        </button>
        <button className="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-xl text-sm font-bold hover:bg-primary/90 transition-colors shadow-sm shadow-violet-500/20 min-h-10">
