...
export function PipelineToolbar({ search, onSearchChange, totalCount }: PipelineToolbarProps) {
  return (
    <div className="flex items-center gap-3 px-6 py-4 border-b border-border flex-shrink-0 bg-card/50">
      ...
      <div className="ml-auto flex items-center gap-4">
        ...
        <button type="button" className="flex items-center gap-2 bg-primary text-white px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-primary/90 transition-colors shadow-sm min-h-10">
