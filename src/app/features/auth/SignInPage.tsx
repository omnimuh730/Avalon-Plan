...
export function SignInPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(false);
    if (result.success) {
      toast.success("Signed in", { description: `Welcome back, ${name.trim()}.` });
  ...
  return (
    <AuthSplitLayout>
      <div className="flex items-center gap-3 mb-8 lg:hidden">
        <div className="w-10 h-10 rounded-xl bg-primary flex items-center justify-center shadow-md shadow-violet-500/25">
      ...
      <div className="hidden lg:flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Use your Athens-server account</p>
        </div>
      </div>
